...
export const metadata: Metadata = { title: "ResiBook", description: "Sistema médico premium", icons: { icon: [{ url: "/resibook-icon.svg", type: "image/svg+xml" }], apple: [{ url: "/apple-icon.png", type: "image/png" }], shortcut: ["/resibook-icon.svg"] } };
export const viewport: Viewport = { themeColor: "#09172d", colorScheme: "light" };
  ...
  return (
    <html lang="pt-BR">
      <body>
        ...
        <Suspense fallback={null}><AccessLogger /></Suspense>
